...
public class App {
	public static void main(String[] args) {
		...
		//CODE STARTS HERE
				...
				Dataset<Row> Overpaid_median = sqlDF.select("empid","dept","job_title").where(sqlDF.col("salary").geq(median_salary));
				//table for employees underpaid wrt the median salary
				Dataset<Row> Underpaid_median = sqlDF.select("empid","dept","job_title").where(sqlDF.col("salary").leq(median_salary));
				...
				Dataset<Row> Over_data = spark.read().json("C:/Users/Administrator/Desktop/Overpaid");//Reading the Overpaid Dataset 
				...
				Dataset<Row> Under_data = spark.read().json("C:/Users/Administrator/Desktop/Underpaid"); //Reading the Underpaid Dataset
